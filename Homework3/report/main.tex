...
To achieve this, a \textbf{Proportional-Derivative} (PD) controller was implemented. It is a
continuous feedback mechanism that computes an error value as the difference between the track
center and the robot's current position, applying a restorative correction.
