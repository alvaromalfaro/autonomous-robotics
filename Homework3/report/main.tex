...
from an initial baseline of approximately $0.17$ down to under $0.08$ by the final lap.
...
transition points at ($3.5, 7.5$) and ($7.5, 3.5$), allowing the robot to enter the curves without
